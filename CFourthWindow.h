 ...
 *
 */
#if !defined __CFourthWindow_H__
#define __CFourthWindow_H__


class CFourthWindow : public CWindowMultimonitor 
{
public:
	CFourthWindow(LPCTSTR lpszCaption, LPWNDCLASSEX lpwndClassEx);
	CFourthWindow(LPCTSTR lpszCaption, HINSTANCE hInstance, LPCTSTR lpszClassName,
