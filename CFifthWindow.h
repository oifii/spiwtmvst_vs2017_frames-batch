 ...
 *
 */
#if !defined __CFifthWindow_H__
#define __CFifthWindow_H__


class CFifthWindow : public CWindowMultimonitor 
{
public:
	CFifthWindow(LPCTSTR lpszCaption, LPWNDCLASSEX lpwndClassEx);
	CFifthWindow(LPCTSTR lpszCaption, HINSTANCE hInstance, LPCTSTR lpszClassName,
