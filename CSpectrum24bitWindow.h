 ...
 *
 */
#if !defined __CSpectrum24bitWindow_H__
#define __CSpectrum24bitWindow_H__

//#define SPECTRUM24BITWINDOW_MAXAUDIOBUFFERSIZE	(2*1920*2)	//max 2 channels and 2 screens 1920x1080
//2021nov29, spi, begin
//#define SPECTRUM24BITWINDOW_MAXAUDIOBUFFERSIZE	(2*1920*2)	//max 2 channels and 2 screens 1920x1080
//#define SPECTRUM24BITWINDOW_MAXAUDIOBUFFERSIZE	(2*2048*2)	//max 2 channels * max framesperbuffer (should be greater than width of a 4K screen or greater than width of 2 screens of 1920x1080)
#define SPECTRUM24BITWINDOW_MAXNUMCHANNELS		2
//#define SPECTRUMWINDOW_MAXFRAMEBUFFER		(2*2048)
//2 * FRAMES_PER_BUFFER
#define SPECTRUM24BITWINDOW_MAXFRAMESPERBUFFER	(2*FRAMES_PER_BUFFER)
...
#define SPECTRUM24BITWINDOW_MAXAUDIOBUFFERSIZE	(2*SPECTRUM24BITWINDOW_MAXNUMCHANNELS*SPECTRUM24BITWINDOW_MAXFRAMESPERBUFFER)	
//2021nov29, spi, end

#define SPECTRUM24BITWINDOW_IDTIMER_UPDATESPECTRUM	1
#define SPECTRUM24BITWINDOW_IDTIMER_UPDATEPARAMETER	12

class CSpectrum24bitWindow : public CWindowParameter 
{
public:
	float _audiobuffer[SPECTRUM24BITWINDOW_MAXAUDIOBUFFERSIZE];

private:
	bool _audiobuffer_ready;
	RGBQUAD* _dibpalette;
	float _buf[SPECTRUM24BITWINDOW_MAXAUDIOBUFFERSIZE];
	float _fftbuf[SPECTRUM24BITWINDOW_MAXAUDIOBUFFERSIZE];
	HDC _specdc;
	HBITMAP _specbmp;
	//2021nov29, spi, begin
...
public:
	CSpectrum24bitWindow(LPCTSTR lpszCaption, LPWNDCLASSEX lpwndClassEx,
		RGBQUAD* dibpalette);
	CSpectrum24bitWindow(LPCTSTR lpszCaption, HINSTANCE hInstance, LPCTSTR lpszClassName,
		RGBQUAD* dibpalette,
