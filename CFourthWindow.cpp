...
CFourthWindow::CFourthWindow(LPCTSTR lpszCaption, LPWNDCLASSEX lpwndClassEx) 
: CWindowMultimonitor(lpszCaption, lpwndClassEx)
{

}

CFourthWindow::CFourthWindow(LPCTSTR lpszCaption, HINSTANCE hInstance, LPCTSTR lpszClassName,
...
CFourthWindow::~CFourthWindow()
{
}

LRESULT CALLBACK CFourthWindow::wndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) 
{
	switch (uMsg)
	{
	case WM_CREATE:
